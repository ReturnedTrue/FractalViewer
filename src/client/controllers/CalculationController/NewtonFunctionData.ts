import { complexSquare, complexPow, complexSine, complexCos, complexTan } from "client/utility/complex";
...
export const newtonFunctionData: Record<NewtonFunction, NewtonFunctionData> = {
